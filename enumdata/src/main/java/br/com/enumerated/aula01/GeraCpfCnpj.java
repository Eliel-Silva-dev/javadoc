...
//fonte do cod.: https://raw.githubusercontent.com/muriloferreira/utilities/master/GeraCpfCnpj.java
public class GeraCpfCnpj {
    ...
    public boolean isCPF(String CPF) {
        ...
        // consifera-se erro CPF's compostos por uma sequencia de numeros iguais
        ...
        // esse bloco try protege o código de eventuais erros de conversão de tipo - int
        try {
            //calcando o primeiro digito verificador
            sm = 0;
            peso = 10;
            ...
            if((r == 10) || (r == 11)) {
                ...
                dig10 = (char) (r + 48); //converter para o respectivo caractere numérico;
            }
            ...
            //verifica se os numeros calculados coincidem com os numeros passados por parametro
    ...
    public boolean isCNPJ(String CNPJ) {
        ...
        // considera-se erro CNPJ's formados por uma sequencia de numeros identicos
        ...
        try {
            // calcula o primeiro dg verificador
            sm = 0;
            peso = 2;
